    ...
    world_map_data = (
        ...
        .set_series_opts(
            ...
            label_opts={'is_show': 'False',
                        'color': '#081832', 'font_size': '18', 'position': 'left'},
        )
        # 全局配置
        .set_global_opts(
            # 视觉映射配置项
            ...
            title_opts=opts.TitleOpts(
                title="世界疫情地图", subtitle=subtitle, pos_left="50", pos_top="5%", title_textstyle_opts=opts.TextStyleOpts(font_size=30), subtitle_textstyle_opts=opts.TextStyleOpts(font_size=18, color='#081832')
            ),
            # 图例设置
            legend_opts=opts.LegendOpts(
                selected_mode='single', pos_top="50", pos_bottom="5%", textstyle_opts=opts.TextStyleOpts(font_size=18)),
        )
        .render(r"C:\Users\renyu\PycharmProjects\djangoProject4\static\world-cov.html")
    )
